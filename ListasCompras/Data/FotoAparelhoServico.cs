...
// As fotos ficam em disco, ao lado do loja.db — não no banco. Base64 na coluna é como a
// logo da loja é guardada hoje, e não escalaria para várias fotos por aparelho.
public static class FotoAparelhoServico
{
    ...
    public static string Pasta => Path.Combine(AppContext.BaseDirectory, "wwwroot", "uploads", "aparelhos");
